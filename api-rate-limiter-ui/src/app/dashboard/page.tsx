...
export default function DashboardPage() {
  ...
  useEffect(() => {
    const loadDashboardData = async () => {
      try {
        ...
        const usersData: Page<any> = await UserPlanService.getAllUsers(0, 1);
        setUsersCount(usersData.totalElements);

        const plansData: Page<any> = await RatePlanService.getAllPlans(0, 1);
        setPlansCount(plansData.totalElements);

        const rulesData: Page<any> = await CustomRuleService.searchCustomRules('', 0, 1);
        setCustomRulesCount(rulesData.totalElements);

        // Keep simulated logs since backend doesn't have log endpoint
  ...
  return (
    <MainLayout>
      ...
      {loading ? (
        <div className="p-8 text-center text-slate-500 text-sm">Loading dashboard data...</div>
      ) : (
        <>
          {/* Top Stat Cards Grid */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            <StatCard
              ...
              value={usersCount}
              subtitle="Total registered API clients"
            ...
            <StatCard
              ...
              value={plansCount}
              subtitle="Available rate limit tiers"
            ...
            <StatCard
              ...
              subtitle="Enterprise client overrides"
              ...
              <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-0.5">
                    Simulated audit trail of rule evaluations and cache updates
                  </p>
                </div>
                <Link
                  href="/redis"
